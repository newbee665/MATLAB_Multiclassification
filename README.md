# MATLAB_multi-classification ensemble model
This project includes the codes to solve the multi-classification problem with a hybrid decomposition strategy and integration feature selection methods.
